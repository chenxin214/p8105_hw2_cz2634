...
*the snp.csv dataset is consist of 787 rows and 3 columns. *the
unemployment.csv dataset is consist of 816 rows and 3 columns. It
records data related to unemployment rate from 1947 to 2015. \*The final
dataset is a combination of the three datasets above. It is comvenient
to comparare the imformations within one table. The datasets includes
1644 rows and 12 columns. The year range from 1947 to 2015.
